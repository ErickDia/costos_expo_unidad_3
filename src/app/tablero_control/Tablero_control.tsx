...
export const Tablero_control = () => {
  ...
  const [objetivos_base, set_Objetivos_base] = useState([
        ...
        },
        {
            objBase_id: 2,
            name_perspectiva: "Financiera",
            objBase_name: "Maximizar retorno de inversion (ROI)",
            name_indicador: "Evaluación de Proyectos de inversión",
            formula_indicador: "Ingresos - Inversión/Inversión",
            fuente_de_datos: "Evaluación de Proyectos de inversión",
